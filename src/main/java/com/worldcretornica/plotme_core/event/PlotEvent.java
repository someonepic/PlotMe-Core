...
public abstract class PlotEvent extends Event
{
    ...
    /**
     * Returns the list of people allowed to build on this plot.
     * The function returns an empty HashSet if the plot is null.
     * 
    ...
    /**
     * Returns the list of people denied from building on this plot.
     * The function returns an empty HashSet if the plot is null.
     * 
    ...
    /**
     * Returns the location of the home of this plot.
     * The function returns null if the plot or world is null.
     * 
